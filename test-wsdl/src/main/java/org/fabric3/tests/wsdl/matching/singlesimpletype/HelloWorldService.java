...
@WebServiceClient(name = "HelloWorldService",
                  targetNamespace = "urn:helloworld:sst",
                  wsdlLocation = "file:/C:/F3Development/test/test-wsdl-matching/wsdl/SingleSimpleType.wsdl")
public class HelloWorldService
        extends Service {

    private final static URL HELLOWORLDSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(org.fabric3.tests.wsdl.matching.singlesimpletype.HelloWorldService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.fabric3.tests.wsdl.matching.singlesimpletype.HelloWorldService.class.getResource(".");
            url = new URL(baseUrl, "file:/C:/F3Development/test/test-wsdl-matching/wsdl/SingleSimpleType.wsdl");
        } catch (MalformedURLException e) {
            logger.warning(
                    "Failed to create URL for the wsdl Location: 'file:/C:/F3Development/test/test-wsdl-matching/wsdl/SingleSimpleType.wsdl', retrying as a local file");
