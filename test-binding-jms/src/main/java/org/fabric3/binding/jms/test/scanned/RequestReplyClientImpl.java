...
public class RequestReplyClientImpl implements RequestReplyClient {

    @JMS(@JMSConfiguration(destination = "ScannedRRQueue"))
    protected RequestReplyConsumer consumer;

    public String invoke(String message) {
        return consumer.invoke(message);
    }
}
